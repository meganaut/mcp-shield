...
/// Credentials MCPShield holds for a downstream integration,
...
/// Inbound auth — validates tokens presented by agents connecting to MCPShield
...
/// Outbound auth — how MCPShield registers itself with a downstream MCP server
...
/// DCR: MCPShield registers itself dynamically with the integration's DCR endpoint.
