...
use mcpcondor_standard::oauth::authorize::{get_authorize, post_authorize};
use mcpcondor_standard::oauth::dcr::post_register;
use mcpcondor_standard::oauth::metadata::get_metadata;
use mcpcondor_standard::oauth::token::post_token;
